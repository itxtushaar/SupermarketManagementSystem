...
# Frames
billing_frame = Frame(root, width=600, height=500, bg="grey")
statistics_frame = Frame(root, width=600, height=500, bg="grey")
dashboard_frame = Frame(root, width=600, height=500, bg="grey")
sales_frame = Frame(root, width=600, height=500, bg="grey")
bill_frame = Frame(root, width=600, height=500, bg="grey")

load_product_frame = Frame(root, width=600, height=500, bg="grey")
add_product_frame = Frame(root, width=600, height=500, bg="grey")
del_product_frame = Frame(root, width=600, height=500, bg="grey")

about_us_frame = Frame(root, width=600, height=500, bg="grey")
contact_us_frame = Frame(root, width=600, height=500, bg="grey")
...
def billing_app_page():
    ...
    cname_lbl = Label(fc1, text="Customer Name:",
                      bg=us_bg, borderwidth=0, fg=us_fg, font=('Bahnschrift 15'))
    cname_lbl.grid(row=0, column=0, padx=10)
    cname_txt = Entry(fc1, width=15, font='Bahnschrift 15')
    cname_txt.grid(row=0, column=1, padx=10)

    cphn_lbl = Label(fc2, text="Email:", bg=us_bg, fg=us_fg,
                     font=('Bahnschrift 15'), borderwidth=0)
    cphn_lbl.grid(row=0, column=2, padx=10)
    cphn_txt = Entry(fc2, width=23, font='CascadiaCode 15')
    ...
    barcode_lbl = Label(barcode, text="Barcode", bg=us_bg, font=(
        'Bahnschrift 15'), width=50, height=20)
...
# ===================================================================
    ...
    Label(manual_mode, text="PRODUCT ID", bg=us_bg, fg=us_fg, font=(
        'Bahnschrift 15')).grid(row=0, column=0)
    ...
    Label(manual_mode, text="QUANTITY", bg=us_bg, fg=us_fg, font=(
        'Bahnschrift 15')).grid(row=0, column=1)
    ...
    discount_lbl = Label(discount, text="Discount",
                         bg=us_bg, fg=us_fg, font=('Bahnschrift 15'))
...
def product_frame_funct():
    ...
    Label(name_detail, text="PRODUCT NAME", bg=us_bg, fg=us_fg, font=(
        'Bahnschrift 15')).grid(row=0, column=0, pady=10)
...
def edit_del_pro():
    ...
    Label(name_detail, text="PRODUCT NAME", fg=us_fg, bg=us_bg, font=('Bahnschrift 15')).grid(row=0, column=0,
                                                                                                     pady=10)
    nd11 = Entry(name_detail, width=15, font='arial 15', state="disable")
    nd11.grid(row=1, column=0, padx=15, pady=20)

    Label(quant_detail, text="QUANTITY", fg=us_fg, bg=us_bg, font=('Bahnschrift 15')).grid(row=0, column=0,
                                                                                                  pady=10)
...
def stats_main_all():  # bill all function
    ...
    Label(cost_detail, text="BILL PROFIT", fg=us_fg, bg=us_bg,
          font=('Bahnschrift 15')).grid(row=0, column=0)
    sac4_e = Text(cost_detail, width=13, height=19, font='arial 15',
                  yscrollcommand=vsb.set, state="disable")
    sac4_e.grid(row=1, column=0)
...
def dashboard_main_analysis():
    ...
    Label(rev_month, text="MONTHLY REVENUE", fg=us_fg, bg=us_bg, font=(
        'Bahnschrift 15')).grid(row=0, column=0, pady=8, padx=10)
    ...
    Label(rev_today, text="TODAY'S REVENUE", fg=us_fg, bg=us_bg, font=(
        'Bahnschrift 15')).grid(row=0, column=0, pady=8, padx=15)
